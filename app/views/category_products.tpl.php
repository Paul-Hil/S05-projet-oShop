<section class="hero">
  <div class="container">
    ...
    <div class="hero-content pb-5 text-center">
      <h1 class="hero-heading">#<?= $viewVars['category']->category_name ; ?></h1>
      <div class="row">
    ...
    <?php foreach($viewVars['products'] as $product): ?>
      ...
      <div class="product col-xl-3 col-lg-4 col-sm-6">
        <div class="product-image">
          <a href="../produit/<?= $product->getId(); ?>" class="product-hover-overlay-link">
        ...
        <div class="product-action-buttons">
          ...
          <a href="../produit/<?= $product->getId(); ?>" class="btn btn-dark btn-buy"><i class="fa-search fa"></i><span class="btn-buy-label ml-2">Voir</span></a>
        </div>
        <div class="py-2">
          <p class="text-muted text-sm mb-1"><?= $viewVars['category']->category_name ?></p>
          <h3 class="h6 text-uppercase mb-1"><a href="../produit/<?= $product->getId(); ?>" class="text-dark"><?= $product->getName() ?></a></h3><span class="text-muted"><?= $product->getPrice() ?>&euro;</span>
        </div>
      </div>
      <!-- /product-->
      <?php endforeach ;?>
