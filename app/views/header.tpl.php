      ...
      <div class="container-fluid">
        ...
        <div id="navbarCollapse" class="collapse navbar-collapse">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <a href="<?= $router->generate('category');?>1" class="nav-link">Catégories</a>
            </li>
            <li class="nav-item">
              <a href="<?= $router->generate('type');?>1" class="nav-link">Types de produit</a>
            </li>
            <li class="nav-item">
              <a href="<?= $router->generate('marque');?>1" class="nav-link">Marques</a>
            </li>
            <li class="nav-item">
